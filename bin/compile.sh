...
java -jar node_modules/google-closure-templates/javascript/SoyToJsSrcCompiler.jar \
  ...
  --srcs app/template/kintone.soy \
  --outputPathFormat app/javascript/kintone.soy.js

java -jar node_modules/google-closure-compiler/compiler.jar \
  --closure_entry_point kintone.setup.init \
  --only_closure_dependencies \
  --js_output_file app/javascript/bundle.min.js \
